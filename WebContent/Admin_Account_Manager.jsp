...
<body>
	<%
		System.out.println("/Admin_Account_Manager.jsp");
		// kiểm tra nếu dữ liệu đầu vào trong request quá lớn
		if (request.getContentLengthLong() > 50000) {
			System.out.println("/Admin_Account_Manager.jsp: dữ liệu đầu vào quá lớn, trở lại trang chủ");
	...
	<%
		...
		try {
			...
			resultset = statement.executeQuery("select UserID, UserName,UserPass,FullName,Quyen from users");
		} catch (Exception e) {
			...
			request.setAttribute("RefererURL", "/Admin_Account_Manager.jsp");
