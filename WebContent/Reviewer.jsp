...
<body>
	<%
		System.out.println("/Reviewer.jsp");
		// kiểm tra nếu dữ liệu đầu vào trong request quá lớn
		if (request.getContentLengthLong() > 50000) {
			System.out.println("/Reviewer.jsp: dữ liệu đầu vào quá lớn, trở lại trang chủ");
	...
	<%
		...
		try {
			...
			try {
				...
				System.out.println("/Reviewer.jsp: load dữ liệu thất bại");
			}
		} catch (Exception e) {
					...
					<form role="form" action="/WEB-INF/Writer_Manager.jsp">
						...
						<div class="form-group">
							...
							<div class="col-md-3 col-md-offset-9">
								<a
									href="Duyet.jsp?Pid=<%=HtmlEncoder.escapeHTML(resultset.getString(5))%>">
									<button type="button" class="btn btn-success" id="btnSubmit">
										<span class="glyphicon glyphicon-ok"></span> Chấp nhận
									</button>
								</a> <a
									href="Huy.jsp?Pid=<%=HtmlEncoder.escapeHTML(resultset.getString(5))%>">
