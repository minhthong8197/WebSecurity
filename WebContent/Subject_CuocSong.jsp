				...
				<div class="container">
								...
								<i class="fa fa-home"></i><span
									...
									typeof="v:Breadcrumb"><a href="index.jsp" rel="v:url"
										...
										typeof="v:Breadcrumb"><a href="Subject_TinTuc.jsp"
											...
											class="breadcrumb_last">Cuộc sống</span></span></span></span>
							</p>
						</li>
					</ol>
					...
					<div class="hk-left-ct">
						...
						<div class="row">
							...
							<div class="list-post-cat">
								<div class="col-xs-12 col-sm-3 col-md-4">
									<a href="News_bao-tang.jsp"><img src="img/giaitri1.jpg"
										alt="Hình ảnh bảo tàng tranh 3D tại Đà Nẵng đầu tiên"
										title="Hình ảnh bảo tàng tranh 3D tại Đà Nẵng đầu tiên" /> </a>
								</div>

								<div class="col-xs-12 col-sm-9 col-md-8">
									<h4>
										<a href="News_bao-tang.jsp">Hình ảnh bảo tàng tranh 3D tại
											Đà Nẵng đầu tiên</a>
									</h4>
									<article class="post-content">
										<p>Art in Paradise Danang là Bảo tàng tranh 3D tại Đà Nẵng
											đầu tiên vừa mới được khai trương ngày 15/07/2017 tại Lô
											C2-10 Trần Nhân Tông, Sơn Trà, Đà Nẵng. Bảo tàng xoay quanh
											vật thể 3 chiều, sử dụng nghệ thuật ngụy trang hay còn được
											gọi là nghệ thuật vẽ trên các bề mặt khác nhau: tường, sàn,
											trần nhà… Đòi hỏi kỹ thuật chuyên môn cao “biến” bức tranh
											trên bề mặt phẳng trở thành ảo ảnh, tạo cảm giác mọi vật đang
											sống động như thật.</p>
									</article>
									<div class="meta">
										<span>13 - 10 - 2017</span>
									</div>
