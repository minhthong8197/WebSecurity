...
<body>
	<%
		System.out.println("/Writer_HocHTMLCSS.jsp");
		// kiểm tra nếu dữ liệu đầu vào trong request quá lớn
		if (request.getContentLengthLong() > 50000) {
			System.out.println("/Writer_HocHTMLCSS.jsp: dữ liệu đầu vào quá lớn, trở lại trang chủ");
	...
	<%
		...
		try {
			...
			request.setAttribute("RefererURL", "/Writer_HocHTMLCSS.jsp");
