...
<body>
	<%
		System.out.println("/Writer_Newpost.jsp");
		// kiểm tra nếu dữ liệu đầu vào trong request quá lớn
		if (request.getContentLengthLong() > 50000) {
			System.out.println("/Writer_Newpost.jsp: dữ liệu đầu vào quá lớn, trở lại trang chủ");
					...
					<form action="NewPost" method="post" role="form">
						<div class="form-group">
							<label>Tên Bài viết</label> <input maxlength="100" type="text"
								...
								viết</label> <input type="date" maxlength="10" class="form-control"
							...
							<div class="col-md-3 col-md-offset-9">
								<button type="submit" class="btn btn-success" id="btnSubmit">Gửi
									bài viết</button>
