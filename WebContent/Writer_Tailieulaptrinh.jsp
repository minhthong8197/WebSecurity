...
<body>
	<%
		System.out.println("/Writer_Tailieulaptrinh.jsp");
		// kiểm tra nếu dữ liệu đầu vào trong request quá lớn
		if (request.getContentLengthLong() > 50000) {
			System.out.println("/Writer_Tailieulaptrinh.jsp: dữ liệu đầu vào quá lớn, trở lại trang chủ");
	...
	<%
		...
		try {
			...
			request.setAttribute("RefererURL", "/Writer_Tailieulaptrinh.jsp");
