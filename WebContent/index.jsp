...
<body>
	<%
		...
		if (request.getContentLengthLong() > 50000) {
			System.out.println("/index.jsp: dữ liệu đầu vào quá lớn, trở lại trang chủ");
								...
								<div class="col-xs-12 col-sm-12 col-md-6">
									<div class="detail-cat">
										...
										<div class="info">
											<div>
												<h2>
													<a href="Subject_CuocSong.jsp">Cuộc Sống</a>
												</h2>
											</div>
										</div>
									</div>
								...
								<div class="col-xs-12 col-sm-12 col-md-6">
									<div class="detail-cat">
										...
										<div class="info">
											<div>
												<h2>
													<a href="Subject_GiaoDuc.jsp">Giáo Dục</a>
												</h2>
											</div>
										</div>
									</div>
								...
								<div class="col-xs-12 col-sm-12 col-md-6">
									<div class="detail-cat">
										...
										<div class="info">
											<div>
												<h2>
													<a href="Subject_GiaiTri.jsp">Giải trí</a>
												</h2>
											</div>
										</div>
									</div>
								...
								<div class="col-xs-12 col-sm-12 col-md-6">
									<div class="detail-cat">
										...
										<div class="info">
											<div>
												<h2>
													<a href="Subject_CongNghe.jsp">Công Nghệ</a>
												</h2>
											</div>
										</div>
									</div>
